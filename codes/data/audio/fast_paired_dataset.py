...
def parse_tsv_aligned_codes(line, base_path):
    ...
    return (
        os.path.join(base_path, f"{fpt[1]}"),
        fpt[0],
        convert_string_list_to_tensor(fpt[2]),
    )
    ...
    def load_random_line(self, depth=0):
        ...
        with open(path, "r", encoding="utf-8") as f:
            ...
            try:  # This can fail when seeking to a UTF-8 escape byte.
                ...
                return (
                    self.load_random_line(depth=depth + 1),
                    type,
...
if __name__ == "__main__":
    ...
    params = {
        ...
        "path": [
            "y:/libritts/train-other-500/transcribed-oco.tsv",

...
if __name__ == "__main__":
    ...
    wav = load_audio(
        "Y:/separated/bt-music-1/100 Hits - Running Songs 2014 CD 2/100 Hits - Running Songs 2014 Cd2 - 02 - 7Th Heaven - Ain't Nothin' Goin' On But The Rent/00001/no_vocals.wav",
        22050,
    )
    mel = TorchMelSpectrogramInjector(
        {
            "n_mel_channels": 256,
            "mel_fmax": 11000,
            "filter_length": 16000,

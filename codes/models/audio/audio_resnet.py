...
class ResNet(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv1d(
            1, self.inplanes, kernel_size=7, stride=4, padding=3, bias=False
        )
        ...
        self.layer2 = self._make_layer(
            block, 128, layers[1], stride=4, dilate=replace_stride_with_dilation[0]
        )
        self.layer3 = self._make_layer(
            block, 256, layers[2], stride=4, dilate=replace_stride_with_dilation[1]
        )
        self.layer4 = self._make_layer(
            block, 512, layers[3], stride=4, dilate=replace_stride_with_dilation[2]
        )

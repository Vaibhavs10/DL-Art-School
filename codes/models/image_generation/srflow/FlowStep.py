...
class FlowStep(nn.Module):
    ...
    def __init__(
        ...
        if flow_permutation == "invconv":
            self.invconv = (
                models.image_generation.srflow.Permutations.InvertibleConv1x1(
        ...
        if flow_coupling == "CondAffineSeparatedAndCond":
            self.affine = models.image_generation.srflow.FlowAffineCouplingsAblation.CondAffineSeparatedAndCond(
